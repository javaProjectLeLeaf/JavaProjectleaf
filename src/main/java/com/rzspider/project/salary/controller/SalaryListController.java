package com.rzspider.project.salary.controller;
 ...
 */
@Controller
@RequestMapping("/salary/salarymanage")
public class SalaryListController extends BaseController {
	...
	@Log(title = "资产管理", action = "资产列表管理-管理查看")
	@GetMapping()
	@RequiresPermissions("salary:salarymanage:view")
	public String bookmanage() {
		return prefix + "/salarymanage";
	}
